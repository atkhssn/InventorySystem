...
namespace app.WebApp.Handlers
{
    ...
    public class MediaService : IMediaService
    {
        ...
        public string UpdateFile(string property, IFormFile file,string folderName)
        {
            if (property != null)
            {
            ...
            string path =folderName!=null? Path.Combine(webrootpath,folderName, filename): Path.Combine(webrootpath, filename);
            using (var fileStream = new FileStream(path, FileMode.Create))
            {
                file.CopyTo(fileStream);
            }
            string fileUrl =folderName!=null? "~/"+ folderName + "/" + filename :"~/" + folder + "/" + filename;
            return fileUrl;
        }
